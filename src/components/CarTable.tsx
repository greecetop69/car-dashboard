...
const TABLE_OPEN_LINK_CLASS =
    "inline-block rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs font-medium text-blue-700 transition hover:bg-blue-100 hover:border-blue-300 text-center";
const INSPECTION_ACTIONS_CLASS =
    "flex min-h-[3rem] items-center justify-center gap-2";
...
const CENTERED_DASH_CLASS =
    "flex min-h-[3rem] items-center justify-center text-slate-400";
...
export default function CarTable({
    ...
    const getOriginBadge = (origin: Car["origin"]) =>
        origin === "kbcha"
            ...
            : origin === "kcar"
              ? { label: "KCAR", className: "bg-violet-500 text-white" }
                ...
                <div className="space-y-3 p-3 md:hidden">
                    ...
                    {cars.map((car) => {
                        ...
                        const showMobileDetails =
                            car.origin !== "kbcha" && car.origin !== "kcar";
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`grid gap-2 ${showMobileDetails ? "grid-cols-2" : "grid-cols-1"}`}
                                >
                                    {showMobileDetails && (
                                        <Button
                                            onClick={() =>
